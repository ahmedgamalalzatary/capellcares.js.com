...
export const Icon = {
  ...
  Logo: ({ size = 28, className }: P) => (<svg width={size} height={size} viewBox="0 0 40 40" className={className}><circle cx="20" cy="20" r="18" fill="#a13b4b"/><text x="20" y="26" textAnchor="middle" fontFamily="Cormorant Garamond, serif" fontSize="20" fill="#faf6f1" fontStyle="italic">M</text></svg>),
