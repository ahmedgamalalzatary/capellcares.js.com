...
export function NavBar() {
  return (
    <nav className="border-b border-gray-100 bg-white">
      <div className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-3 text-[13px] font-semibold tracking-wide text-navy">
        <ul className="flex items-center gap-7">
          {NAV_ITEMS.map((item) => (
            <li key={item.label}>
              <a href="#" className="flex items-center gap-1 hover:text-amber-500">
                {item.label}
        ...
        <div className="flex items-center gap-7">
          ...
          <a href="#" className="flex items-center gap-1.5 hover:text-amber-500" aria-label="Wishlist">
