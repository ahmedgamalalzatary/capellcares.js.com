    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-50 flex cursor-pointer items-center gap-2 rounded-full bg-white px-3 py-3 text-sm font-semibold text-brand-dark shadow-[0_5px_24px_rgba(53,58,63,0.28)] transition hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(53,58,63,0.34)] sm:bottom-6 sm:right-6 sm:px-4"
        >
