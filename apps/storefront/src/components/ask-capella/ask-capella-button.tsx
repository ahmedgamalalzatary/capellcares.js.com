    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-6 inset-e-6 z-50 flex items-center gap-2.5 rounded-(--radius-pill) bg-accent px-3 py-3 text-white shadow-[0_4px_20px_color-mix(in_oklch,var(--accent)_45%,transparent)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[oklch(0.44_0.14_38)] hover:shadow-[0_8px_28px_color-mix(in_oklch,var(--accent)_50%,transparent)] sm:px-5"
        ...
        >
          ...
          <span className="hidden font-(--font-display) italic text-base leading-none sm:inline">{dict.ask.button}</span>
        </button>
      )}
