...
export function CheckoutView({ lang, dict }: CheckoutViewProps) {
  ...
  if (orderId) {
    return (
      <div className="mx-auto my-8 grid max-w-130 place-items-center gap-4 border border-(--hairline) bg-surface px-5 py-10 text-center shadow-(--shadow-1) sm:my-12 sm:px-8 sm:py-14">
        ...
        <div className="mt-2 grid gap-1">
          ...
          <div className={` bg-(--warm-soft) px-7 py-3 tracking-[0.08em] text-ink ${lang === "ar"
  ...
  if (resolved.length === 0) {
    return (
      <div className="mx-auto my-16 grid max-w-105 place-items-center gap-3 border border-(--hairline) bg-surface px-8 py-14 text-center">
